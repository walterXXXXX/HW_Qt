...
void MainWindow::StartRace(void){
    ...
    if(ui->rb_qtConcur->isChecked()){
        ...
        // вариант с цепочкой вычислений then()

        auto lmbRace1 = [this]{concurRace1->DoWork(&number, false, ui->sb_initNum->value());};
        auto lmbRace2 = [this]{concurRace2->DoWork(&number, false, ui->sb_initNum->value());};
        QtConcurrent::run(lmbRace1).then(lmbRace2);

        // вариант с использованием QFutureWatcher

//        QFutureWatcher<void> *futRace1Wh = new QFutureWatcher<void>(this);
//        QFuture<void> futRace1 = QtConcurrent::run(&ExampleRace::DoWork, concurRace1, &number, false, ui->sb_initNum->value());
//        futRace1Wh->setFuture(futRace1);
//        connect(futRace1Wh, &QFutureWatcher<void>::finished, this, [this]{
//            QtConcurrent::run(&ExampleRace::DoWork, concurRace2, &number, false, ui->sb_initNum->value());
//        });
